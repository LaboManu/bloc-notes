...
?>
<hr/><form action="?composant=rename.txt&document=" method="GET">
...
<hr/><form action="?composant=save.txt&document=<?php echo rawurlencode($document); ?>" method="GET">
...
<hr/><hr/><form action="?composant=del.txt&document=<?php echo rawurlencode($document); ?>" method="GET">
